...
var AppComponent = /** @class */ (function () {
    function AppComponent(rtc, rooms, user) {
        this.rtc = rtc;
        this.rooms = rooms;
        this.user = user;
        this.title = 'Chat';
        // rooms.getRooms().subscribe(x => console.log(x));
        user.getUser().subscribe(function (x) { return console.log(x); });
    }
...
var AuthComponent = /** @class */ (function () {
    function AuthComponent(user, router) {
        this.user = user;
        this.router = router;
    }
    AuthComponent.prototype.ngOnInit = function () {
    };
    AuthComponent.prototype.createUser = function (name) {
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(cdr, rooms, rtcService) {
        var _this = this;
        this.cdr = cdr;
        this.rooms = rooms;
        ...
        this.rooms.getRooms().subscribe(function (x) { return _this.RoomsSubject.next(x); });
        this.rtcService.getConnectedObservable().subscribe(function (connected) { return _this.showStreaming(connected); });
    }
    ChatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rtcService.getPeerMessages().subscribe(function (peerMessage) {
            _this.messages.push({ sentByMe: false, message: peerMessage.message });
    ...
    ChatComponent.prototype.sendMessage = function (messageInput) {
        ...
        messageInput.value = '';
        if (message.trim() !== '') {
            this.rtcService.sendPeerMessage({ message: message });
            this.messages.push({ sentByMe: true, message: message });
        }
    };
    ChatComponent.prototype.createRoom = function () {
        this.rooms.createRoom('New Room');
    };
    ChatComponent.prototype.joinRoom = function (roomId) {
        this.rooms.joinRoom(roomId);
    };
    ChatComponent.prototype.startVideoCall = function () {
        this.rtcService.toggleVideo();
        this.rtcService.toggleAudio();
    };
    ChatComponent.prototype.startAudioCall = function () {
        this.rtcService.toggleAudio();
    };
    ChatComponent.prototype.toggleVideo = function () {
        this.rtcService.toggleVideo();
    };
    ChatComponent.prototype.showStreaming = function (connected) {
        if (connected) {
    ...
    ChatComponent.prototype.toggleFullscreen = function () {
...
var EncryptionService = /** @class */ (function () {
    ...
    EncryptionService.prototype.encryptMessage = function (message) {
        var decoded;
        ...
        var encryptedMessage = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["box"])(decoded, this.nonce, this.peerPublicKey, this.keyPair.secretKey);
    ...
    EncryptionService.prototype.decryptMessage = function (message) {
        var msg = this.objectToUInt8Array(message.message);
        var nonce = this.objectToUInt8Array(message.nonce);
        var payload = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["box_open"])(msg, nonce, this.peerPublicKey, this.keyPair.secretKey);
        // const payload = secretbox_open(msg, nonce, decodeBase64('5U9kClQfILAXvan+AaoE3APEpvllHa022pM9EqkxTAM='));
        var utf8 = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["encodeUTF8"])(payload);
        return utf8;
    };
    EncryptionService.prototype.symetricEncrypt = function (message) {
        var decoded;
        if (Object(util__WEBPACK_IMPORTED_MODULE_3__["isString"])(message)) {
            decoded = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["decodeUTF8"])(message);
        }
        ...
        var encryptedMessage = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["secretbox"])(decoded, this.nonce, this.secret);
        return { message: encryptedMessage, nonce: this.nonce };
    };
    EncryptionService.prototype.symetricDecrypt = function (message) {
        var msg = this.objectToUInt8Array(message.message);
        var nonce = this.objectToUInt8Array(message.nonce);
        var payload = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["secretbox_open"])(msg, nonce, this.secret);
        var utf8 = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["encodeUTF8"])(payload);
        return utf8;
    };
    EncryptionService.prototype.getSymetricKey = function () {
        return this.encryptMessage(this.secret).message;
    };
    EncryptionService.prototype.setSymetricKey = function (secret) {
    ...
    EncryptionService.prototype.setPeerPublicKey = function (key) {
        this.peerPublicKey = key;
    };
    EncryptionService.prototype.stringToUint8Array = function (string) {
        var decoded = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["decodeUTF8"])(string);
        return decoded;
    };
    EncryptionService.prototype.uInt8ArrayToString = function (array) {
        var decoded = Object(tweetnacl_ts__WEBPACK_IMPORTED_MODULE_2__["encodeUTF8"])(array);
        return decoded;
    };
    EncryptionService.prototype.objectToUInt8Array = function (object) {
        var temp = [];
...
var RoomService = /** @class */ (function () {
    function RoomService(signaling) {
        var _this = this;
        this.signaling = signaling;
        this.rooms = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
        this.signaling.connect();
        this.signaling.emit({ event: 'rooms', data: {} });
        this.signaling.onEvent('new_room').subscribe(function (data) { return _this.addRoom(data); });
        this.signaling.onEvent('room_created').subscribe(function () { });
    }
    RoomService.prototype.joinRoom = function (id) {
        this.signaling.emit({ event: 'join_room', data: { id: id } });
    };
    RoomService.prototype.getRooms = function () {
        return this.rooms.asObservable();
    };
    RoomService.prototype.createRoom = function (name) {
        this.signaling.emit({ event: 'new_room', data: { name: name } });
    };
    RoomService.prototype.addRoom = function (room) {
        var newRooms = this.rooms.getValue();
        newRooms.push(room);
...
var RTCService = /** @class */ (function () {
    function RTCService(encryptionService, rooms, signaling) {
        var _this = this;
        ...
        this.signaling.connect();
        this.signaling.onEvent('new_room').subscribe(function (data) { });
        this.rooms.getRooms().subscribe(function (rooms) { });
        this.signaling.onEvent('user_joined').subscribe(function () { return _this.sendOffer(); });
        this.signaling.onEvent('receive_offer').subscribe(function (offer) {
            var receivedOffer = new RTCSessionDescription(JSON.parse(offer));
            _this.setOffer(receivedOffer);
        });
        this.signaling.onEvent('receive_answer').subscribe(function (answer) {
            var receivedAnswer = new RTCSessionDescription(JSON.parse(answer));
            _this.setAnswer(receivedAnswer);
        });
        this.signaling.onEvent('receive_ice').subscribe(function (ice) { return _this.inboundIceSubject.next(new RTCIceCandidate(JSON.parse(ice))); });
    }
    RTCService.prototype.sendPeerMessage = function (message) {
        // const encMessage = this.encryptionService.encryptMessage(JSON.stringify(message));
        var encMessage = this.encryptionService.symetricEncrypt(JSON.stringify(message));
        ...
        var json = JSON.stringify(encMessage);
        var binary = encoder.encode(json);
        this.dataChannel.send(binary);
    };
    RTCService.prototype.getConnectedObservable = function () {
        return this.connectedSubject.asObservable();
    };
    RTCService.prototype.showVideo = function (local, remote) {
    ...
    RTCService.prototype.setOffer = function (offer) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var answer;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.createRTCPeerConnection()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.peerConnection.createAnswer(this.offerOptions)];
                    case 4:
                        answer = _a.sent();
                        this.peerConnection.setLocalDescription(answer);
                        this.signaling.emit({ event: 'send_answer', data: answer });
                        this.findIceCandidate();
                        this.iceSubject.subscribe(function (ice) { return _this.signaling.emit({ event: 'send_ice', data: ice }); });
                        return [2 /*return*/, answer];
                }
            });
        });
    };
    RTCService.prototype.sendOffer = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var offer;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.peerConnection.createOffer(this.offerOptions)];
                    case 3:
                        offer = _a.sent();
    ...
    RTCService.prototype.getLocalStream = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, devices;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.localStream) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, navigator.mediaDevices.getUserMedia({ video: true, audio: false })];
                    case 1:
                        _a.localStream = _b.sent();
                        _b.label = 2;
                    case 2: return [4 /*yield*/, navigator.mediaDevices.enumerateDevices()];
                    case 3:
                        devices = _b.sent();
                        devices.forEach(function (device) { return console.log(device); });
                        return [2 /*return*/, this.localStream];
                }
            });
        });
    };
    RTCService.prototype.listenToIceCandidates = function () {
        return this.iceSubject.asObservable();
    };
    RTCService.prototype.addIce = function (ice) {
        this.inboundIceSubject.next(ice);
    };
    RTCService.prototype.setAnswer = function (answer) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    RTCService.prototype.sendMessage = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    RTCService.prototype.sendStream = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getLocalStream()];
                    case 1:
                        (_a.sent()).getTracks().forEach(function (track) {
                            try {
                                _this.peerConnection.addTrack(track, _this.localStream);
                            }
                            catch (ex) {
    ...
    RTCService.prototype.toggleVideo = function () {
        this.localStream.getTracks().forEach(function (track) {
            if (track.kind === 'video') {
    ...
    RTCService.prototype.toggleAudio = function () {
        this.localStream.getTracks().forEach(function (track) {
            if (track.kind === 'audio') {
                track.enabled = !track.enabled;
            }
    ...
    RTCService.prototype.getPeerMessages = function () {
        return this.peerConnectionMessageSubject.asObservable();
    };
    RTCService.prototype.findIceCandidate = function () {
        var _this = this;
        this.peerConnection.onicecandidate = function (ice) {
            if (ice.candidate) {
                _this.iceSubject.next(ice.candidate);
                return ice.candidate;
            }
        };
    };
    RTCService.prototype.createDataChannel = function () {
        var _this = this;
        ...
        this.dataChannel.onopen = function (e) {
            ...
            console.log(_this.encryptionService.getPublicKey());
            _this.dataChannel.send(_this.encryptionService.getPublicKey());
        };
        ...
        this.dataChannel.onmessage = function (e) {
            if (firstMessage) {
                ...
                console.log(e.data);
                var peerPublicKey = new Uint8Array(e.data);
                _this.encryptionService.setPeerPublicKey(peerPublicKey);
                ...
                console.log(e.data);
                _this.encryptionService.setSymetricKey(e.data);
                hasSymetric = true;
                return;
            }
            else {
                var decoder = new TextDecoder();
                var decodedData = decoder.decode(e.data);
                var message = JSON.parse(decodedData);
                // const decMessage = this.encryptionService.decryptMessage(message);
                var decMessage = _this.encryptionService.symetricDecrypt(message);
                _this.peerConnectionMessageSubject.next(JSON.parse(decMessage));
            }
        };
    };
    RTCService.prototype.waitForDataChannel = function () {
        var _this = this;
        this.peerConnection.ondatachannel = function (event) {
            ...
            _this.dataChannel.onmessage = function (e) {
                if (firstMessage) {
                    ...
                    _this.encryptionService.setPeerPublicKey(peerPublicKey);
                    console.log('SECRET KEY');
                    console.log(_this.encryptionService.getSymetricKey());
                    _this.dataChannel.send(_this.encryptionService.getSymetricKey());
                    firstMessage = false;
                }
                else {
                    var decoder = new TextDecoder();
    ...
    RTCService.prototype.createRTCPeerConnection = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var configurations;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.peerConnection.onicegatheringstatechange = function (event) {
                            if (_this.peerConnection.iceGatheringState === 'gathering') {
                                _this.inboundIceSubject.subscribe(function (ice) {
                                    _this.peerConnection.addIceCandidate(ice);
                                });
                            }
                        };
    ...
    RTCService.ctorParameters = function () { return [
...
var SignalingService = /** @class */ (function () {
    ...
    SignalingService.prototype.connect = function () {
        if (!this.connected) {
            this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_2__(URL);
            this.connected = true;
        }
    };
    SignalingService.prototype.emit = function (event) {
        this.socket.emit(event.event, JSON.stringify(event.data));
    };
    SignalingService.prototype.onEvent = function (eventName) {
        var _this = this;
        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
            _this.socket.on(eventName, function (data) { return observer.next(data); });
        });
    };
...
var UserService = /** @class */ (function () {
    function UserService(signaling) {
        var _this = this;
        this.signaling = signaling;
        this.user = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
        this.signaling.connect();
        this.signaling.onEvent('new_user').subscribe(function (data) { return _this.user.next(data); });
    }
